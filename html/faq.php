...
<div  class="w-100 bg-grey span-vh">
    <div class="bg-grey span-vh m-auto w-90">
        ...
        <div>
            <h3>Why should we shop at UOIT Shoes?</h3>
            <p>We provide rare size 10 shoes for cheap and affordable prices.</p>
        </div>
        <div>
        ...
        <div>
            ...
            <p>We accept all forms of online payment, but we will not accept any cryptocurrency.</p>
        </div>
    </div>
</div>
</body>
