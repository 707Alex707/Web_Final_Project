...
function validBillingInfo() {
    ...
    var nameCheck = /^[A-Za-z]{1,} [A-Za-z]{1,}$|^[A-Za-z]{1,} [A-Za-z]{1,} [A-Za-z]{1,}$/;
    ...
    var postalCheck = /^[ABCEGHJKLMNPRSTVXYabcrghjklmnprstvxy][0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz][0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyzs][0-9]$|^[ABCEGHJKLMNPRSTVXYabcrghjklmnprstvxy][0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyz] [0-9][ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvwxyzs][0-9]$/;
...
function validCreditInfo() {
    ...
    //Create regex sequences to validate the user's input
    var cNameCheck = /^[A-Za-z]{1,} [A-Za-z]{1,}$|^[A-Za-z]{1,} [A-Za-z]{1,} [A-Za-z]{1,}$/;
